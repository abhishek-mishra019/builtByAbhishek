import "./chunk-ZUPGCNCK.js";
import {
  isPlatformServer
} from "./chunk-DBIMQFTW.js";
import {
  FIREBASE_APP_NAME,
  FIREBASE_OPTIONS,
  VERSION as VERSION2,
...
import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-EEVMN3QU.js";
import "./chunk-B2KI3AIV.js";
import {
  __async,
  __spreadValues,
  __superGet
} from "./chunk-TPUL5S2B.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-7YH4MXMJ.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
